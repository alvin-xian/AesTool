...
std::string base64_decode(std::string const& encoded_string, unsigned int *out_length) {
...
std::string base64_url_decode(std::string const& encoded_string, unsigned int *out_length) {
    int in_len = encoded_string.size();
    int i = 0;
    int j = 0;
    int in_ = 0;
    ...
    std::string ret;
    (*out_length) = 0;
    while (in_len-- && ( encoded_string[in_] != '=') && is_url_base64(encoded_string[in_])) {
        char_array_4[i++] = encoded_string[in_]; in_++;
        if (i ==4) {
            for (i = 0; i <4; i++)
